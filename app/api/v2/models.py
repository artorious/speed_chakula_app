...
class DatabaseManager():
    ...
    def __init__(self):
        self.conn = None
        self.user_table_query = "CREATE TABLE IF NOT EXISTS users (\
        ...
        self.menu_table_query = "CREATE TABLE IF NOT EXISTS  menu (\
            foodid SERIAL PRIMARY KEY, \
            userid INT NOT NULL REFERENCES users(userid), \
            unit_price INT NOT NULL, \
            description VARCHAR(100) UNIQUE NOT NULL\
            );"
        self.food_orders_query = "CREATE TABLE IF NOT EXISTS orders (\
